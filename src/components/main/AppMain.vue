    ...
    <div class="container p-5">
        ...
        <div class="row justify-content-between">
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
                ...
                <p> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident veritatis laboriosam reiciendis! Vel
                    ...
                    placeat, dicta beatae eligendi minus sed in, animi fugit saepe! Dignissimos, et. Deleniti maxime fuga ea
                    sint accusamus dolorem esse numquam nostrum explicabo sapiente voluptatem dolorum, harum velit sed in
